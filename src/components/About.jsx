        ...
        <>
            <div className="bg-purple-leo my-10 grid gap-4 grid-rows-2">
                <div className="flex p-4 w-full justify-center">
                    <img className="" src="src\assets\img\profileImage.png" alt="" />
                </div>
                <div className="p-3">
                    <h6 className="mt-12 mr-3 text-center text-cream-leo  h-14 text-5xl font-pixelify">Hi there, I'm Leo!</h6>
